CXXFLAGS=-Wall -O3 -g
OBJECTS=demo-main.o minimal-example.o text-example.o led-image-viewer.o miked.o
BINARIES=led-matrix minimal-example text-example miked
...
miked : miked.o $(RGB_LIBRARY)
	$(CXX) $(CXXFLAGS) miked.o -o $@ $(LDFLAGS)
